...
export const PinPerspective = ({
  ...
  return (
    ...
    <motion.div className="pointer-events-none w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 group-hover/pin:pointer-events-auto z-[60] transition duration-500">
